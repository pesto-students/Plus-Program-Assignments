...
Lab 2:
// Step 1: Switch to the "my_database" (if you're not already in it)
use my_database

// Step 2: Perform an aggregation to get the average age of all documents
...
// Step 3: Add an index on the "name" field to improve query performance
db.my_collection.createIndex({ name: 1 })

// Step 4: Perform another aggregation using the created index
db.my_collection.aggregate([
  {
    $match: {
      name: "John"
